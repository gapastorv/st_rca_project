...
def add_coordinates_to_firebase(dataframe, collection_name, subject, info_type):
    firebase_db = FirebaseDB()
    return firebase_db.add_coordinates(dataframe, collection_name, subject, info_type)
